<script lang="ts">
	...
	let loading = false;
	let isActive = data.patient.isActive;
...
<form use:enhance={handleEdit} method="POST" action="?/editPatient">
	<div class="grid gap-6 mb-6 md:grid-cols-2">
		...
		<input type="hidden" value={data.patient.id} name="id" id="id" />
		<div>
		...
		<div>
			...
			<InputMask
				...
				size={16}
				name="phone"
				value={data.patient.phones.find((ph) => !ph.isChat)?.value}
			/>
		</div>
		<div>
